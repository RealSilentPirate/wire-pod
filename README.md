...
The installation guide exists on the wiki: [Installation guide](https://github.com/RealSilentPirate/wire-pod/wiki/Installation)

## Wiki

Check out the [wiki](https://github.com/RealSilentPirate/wire-pod/wiki) for more information on what wire-pod is, a guide on how to install wire-pod, troubleshooting, how to develop for it, and for some generally helpful tips.
